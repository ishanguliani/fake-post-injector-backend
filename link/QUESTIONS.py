...
# new questions
WHY_DID_YOU_CLICK = "Why did you click on this link?"
WHY_DID_YOU_NOT_CLICK = "Why did you not click on this link?"
WHAT_TYPES_OF_POSTS = "What types of posts does this account generally share?"
QUESTIONS = {0: 'Did you click on this link?'  # Question 1
    , 1: 'Does this account usually share posts like this?'  # Question 2
    , 21: WHY_DID_YOU_CLICK + ' ' + "Please select all that apply. \n "
    ...
    , 22: WHY_DID_YOU_NOT_CLICK + ' ' + "Please select all that apply. \n "
    ...
    , 6: WHAT_TYPES_OF_POSTS + ' ' + 'Select all that apply.\n '
...
INPUT_TEXT_MULTIPLE_CHOICE_QUESTION_SET.add((21, WHY_DID_YOU_CLICK))
INPUT_TEXT_MULTIPLE_CHOICE_QUESTION_SET.add((22, WHY_DID_YOU_NOT_CLICK))
INPUT_TEXT_MULTIPLE_CHOICE_QUESTION_SET.add((6, WHAT_TYPES_OF_POSTS))
